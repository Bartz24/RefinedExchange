...
public class BlockEMCCrafter extends BlockContainer {
	...
	public BlockEMCCrafter() {
		super(Material.ROCK);
		this.setUnlocalizedName(References.ModID + "." + "emcCrafter");
		this.setCreativeTab(ModCreativeTabs.tabMain);
		this.setHardness(8F);
		this.setResistance(8F);
		this.setRegistryName("emcCrafter");
	...
	public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand,
		...
		if (!world.isRemote)
			player.openGui(RefinedExchange.instance, ModGuiHandler.EMCCrafterGUI, world, pos.getX(), pos.getY(),
					pos.getZ());
		return true;
	}
